touch# Data Science Unit 3 Sprint Challenge 1
...
I believe an import part of code reviews are comments. I like to add as many comments as I can
to ensure it's understandable. I appreciate when others let me know if I need to add more or maybe less.
I feel if you have a strong resence with your comments, beginners like myself could follow along easily.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

The containers can house those slightly different things running. It'll help with computer resources and
help the computer to run at optimal efficiency. 
